...
class MovieDetailsPage extends Component {
    ...
    render() {
        return (
            <MovieDetailsStyled>
                <button className="goBackButton" type="button" onClick={this.handleBack}>
                    Back
        </button>
                <PreviewMovie
                ...
                <ul className="" key={this.state.id}>
                    <li>
                        <NavLink className="list" to={`${this.props.match.url}/cast`}>Cast</NavLink>
                    </li>
                    <li>
                        <NavLink className="list" to={`${this.props.match.url}/reviews`}>Reviews</NavLink>
                    </li>
                </ul>
